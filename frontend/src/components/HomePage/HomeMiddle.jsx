...
export default function HomeMiddle() {
  return (
    <div className='home-middle' tabIndex={2}>
        <div className='home-middle-content' id='hmc_1' tabIndex={1}>
            {/* <div className='hmc_1_img_block'> */}
        ...
        <div className='home-middle-content' id='hmc_2' tabIndex={2}>
            {/* <div className='hmc_1_img_block'> */}
            <img src={bg4} alt="" height='350px' />
                <div>
                    <h1>The Book Club</h1>
        ...
        <div className='home-middle-content' id='hmc_3' tabIndex={3}>
            {/* <div className='hmc_1_img_block'> */}
            <img src={bg4} alt="" height='350px' />
                <div>
                    <h1>The Book Club</h1>
        ...
        <div className='home-middle-content' id='hmc_4' tabIndex={4}>
            {/* <div className='hmc_1_img_block'> */}
            <img src={bg4} alt="" height='350px' />
                <div>
                    <h1>The Book Club</h1>
        ...
        <div className='home-middle-content' id='hmc_5' tabIndex={5}>
            {/* <div className='hmc_1_img_block'> */}
            <img src={bg4} alt="" height='350px' />
            <div>
                <h1>The Book Club</h1>
