...
export default function TeamMain() {
    ...
    let [dispalyTeam, setDispalyTeam] = useState('current')
        ...
        <div className='teams-main-body'>
            <div className='teams-nav-panel'>
            {
                teamsNavPanelItems.map((item) =>(
                    <div className='teams-nav-panel-items'>{item.title}
                        <ul className='teams-nav-drop-down-ul'>
                            {
                                item.dropdown.map((i) =>(
                                    <button key={i.title} className="teams-nav-dropdown-items" tabIndex={i.index}>
                                        {i.title}
                                    </button>
                                ))
                            }
